...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Theoph_tblNCA_selected <-}\StringTok{ }\NormalTok{Theoph_tblNCA[ , }\KeywordTok{c}\NormalTok{(}\StringTok{'ID'}\NormalTok{, }\StringTok{'CMAX'}\NormalTok{, }\StringTok{'TMAX'}\NormalTok{, }\StringTok{'AUCLST'}\NormalTok{)]}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Indometh_tblNCA_selected <-}\StringTok{ }\NormalTok{Indometh_tblNCA[ , }\KeywordTok{c}\NormalTok{(}\StringTok{'ID'}\NormalTok{, }\StringTok{'CMAX'}\NormalTok{, }\StringTok{'TMAX'}\NormalTok{, }\StringTok{'AUCLST'}\NormalTok{)]}
...
##    0.9999995           NA  148.9230500  148.9230500  216.6119330 
##      AUCIFOD       AUCIFP      AUCIFPD       AUCPEO       AUCPEP 
##    0.6769123  216.6149558    0.6769217   31.2489169   31.2498763 
##      AUCPBEO      AUCPBEP      AUMCLST      AUMCIFO      AUMCIFP 
##           NA           NA 1459.0711035 4505.5348194 4505.6708646 
##      AUMCPEO      AUMCPEP     MRTIVLST     MRTIVIFO     MRTIVIFP 
##   67.6160287   67.6170065           NA           NA           NA 
##     MRTEVLST     MRTEVIFO     MRTEVIFP          VZO          VZP 
##    9.7974834   20.8000305   20.8003683           NA           NA 
##         VZFO         VZFP          CLO          CLP         CLFO 
##   30.4867482   30.4863228           NA           NA    1.4772963 
##         CLFP         VSSO         VSSP 
##    1.4772757           NA           NA 
## attr(,"units")
##  [1] ""          "mg/L"      "mg/L/mg"   "h"         "h"        
...
\NormalTok{desc_tblNCA <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(tblNCA)\{}
  \KeywordTok{as.data.frame}\NormalTok{(tblNCA) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{mutate_all}\NormalTok{(}\ControlFlowTok{function}\NormalTok{(x) }\KeywordTok{as.numeric}\NormalTok{(}\KeywordTok{as.character}\NormalTok{(x))) }\OperatorTok{%>%}\StringTok{ }
...
\midrule
ID & 12 & 6.500000 & 3.605551 & 6.50000 & 6.5000 & 4.447800 & 1.00000 & 12.000 & 11.0000 & 0.0000000 & -1.501603 & 1.0408330\\
...
column & n & mean & sd & median & trimmed & mad & min & max & range & skew & kurtosis & se\\
\midrule
ID & 6 & 3.500000 & 1.8708287 & 3.500 & 3.500000 & 2.2239000 & 1.00000 & 6.00000 & 5.0000 & 0.0000000 & -1.797619 & 0.7637626\\
...
##  [2] "                       Package version 0.1.2 (2018-06-04)"                          
##  [3] "                          R version 3.5.1 (2018-07-02)"                             
##  [4] ""                                                                                   
##  [5] "Date and Time: 2018-07-17 16:43:03 Asia/Seoul"                                      
##  [6] ""                                                                                   
...
## [66] "MRTEVLST   MRT Extravasc to Last Nonzero Conc              9.7975 h"                
## [67] "MRTEVIFO   MRT Extravasc Infinity Obs                     20.8000 h"                
## [68] "MRTEVIFP   MRT Extravasc Infinity Pred                    20.8004 h"                
## [69] "VZFO       Vz Obs by F                                    30.4867 L"                
## [70] "VZFP       Vz Pred by F                                   30.4863 L"                
## [71] "CLFO       Total CL Obs by F                               1.4773 L/h"              
## [72] "CLFP       Total CL Pred by F                              1.4773 L/h"
\end{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{pdfNCA}\NormalTok{(}\DataTypeTok{fileName=}\StringTok{"Output-ncar/pdfNCA-Theoph.pdf"}\NormalTok{, Theoph, }\DataTypeTok{colSubj=}\StringTok{"Subject"}\NormalTok{, }
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{rtfNCA}\NormalTok{(}\DataTypeTok{fileName=}\StringTok{"rtfNCA-Theoph.rtf"}\NormalTok{, Theoph, }\DataTypeTok{colSubj=}\StringTok{"Subject"}\NormalTok{, }
       \DataTypeTok{colTime=}\StringTok{"Time"}\NormalTok{, }\DataTypeTok{colConc=}\StringTok{"conc"}\NormalTok{, }\DataTypeTok{dose=}\DecValTok{320}\NormalTok{, }\DataTypeTok{doseUnit=}\StringTok{"mg"}\NormalTok{, }
       \DataTypeTok{timeUnit=}\StringTok{"h"}\NormalTok{, }\DataTypeTok{concUnit=}\StringTok{"mg/L"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\chapter{세션 정보}\label{sessioninfo}
