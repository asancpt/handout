...
\subsection{R에 대하여}\label{r-}

R {[}@R-base{]}은 통계 소프트웨어 입니다. 굉장히 유용한 소프트웨어이지만
이에 대해 여기서 자세히 설명하긴 힘듭니다. R에 대한 많은 책들을
bookdown.org\footnote{\url{https://bookdown.org}}에서 무료로 읽을 수
있습니다. Coursera\footnote{\url{https://coursera.com}}에서 무료 온라인
강의를 들을 수 있습니다.

\subsection{자료 탐색}\label{-}
...
\subsection{파라메터의 의미}\label{parameters}
...
\section{패키지: NonCompart}\label{-noncompart}

\subsection{tblNCA(): 전체 대상자 비구획 분석}\label{tblnca----}
...
##  [2] "                       Package version 0.3.8 (2018-04-10 KST)"                      
##  [3] "                          R version 3.5.0 (2018-04-23)"                             
##  [4] ""                                                                                   
##  [5] "Date and Time: 2018-08-06 11:33:15 Asia/Seoul"                                      
##  [6] ""                                                                                   
...
\section{패키지: pkr}\label{-pkr}

\subsection{plotPK()}\label{plotpk}
...
\section{참고문헌}\label{references}

\section{세션 정보}\label{sessioninfo}
...
##  ncar        * 0.3.8   2018-04-10 CRAN (R 3.5.0)
##  nlme          3.1-137 2018-04-07 CRAN (R 3.5.0)
##  NonCompart  * 0.4.1   2018-04-16 CRAN (R 3.5.0)
##  parallel      3.5.0   2018-04-23 local         
##  pillar        1.2.2   2018-04-26 CRAN (R 3.5.0)
##  pkgconfig     2.0.1   2017-03-21 CRAN (R 3.5.0)
##  pkr         * 0.1.1   2017-07-10 CRAN (R 3.5.0)
...
##  rtf         * 0.4-11  2013-11-12 CRAN (R 3.4.3)
